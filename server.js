...
try { db.exec("ALTER TABLE products ADD COLUMN focus_keyword TEXT"); } catch(e) {}
...
<head>
    ...
    <link rel="icon" type="image/png" href="/${(s.store_favicon || s.store_logo || 'images/logo.png').replace(/^\/+/, '')}">
    <link rel="shortcut icon" href="/${(s.store_favicon || s.store_logo || 'images/logo.png').replace(/^\/+/, '')}">
    <link rel="apple-touch-icon" href="/${(s.store_favicon || s.store_logo || 'images/logo.png').replace(/^\/+/, '')}">
